...
import GB from "../../assets/images/background/post-back.webp";
import Man3 from "../../assets/images/others/img-02.png";
import Man2 from "../../assets/images/others/img-01.png";
...
const steps = [
  { key: 0, label: "Details", Icon: StepperIcon.Details },
  { key: 1, label: "Gallery", Icon: StepperIcon.Gallery },
  { key: 2, label: "Finish", Icon: StepperIcon.Finish },
];
...
const PostAdd = () => {
  ...
  const heroMan = useMemo(() => {
    if (activeStep === 0) return Man1;
    if (activeStep === 1) return Man2;
    return Man3;
  }, [activeStep]);

  const displayImages = useMemo(() => {
    return imagePreviewUrls.length > 0 ? imagePreviewUrls : [GB];
  }, [imagePreviewUrls]);
  ...
  const progressPercentage = useMemo(() => {
    ...
    // Step 1 (Details) progress - weights all required fields equally
    const step1Fields = [
      formData.title.trim(),
      formData.category,
      formData.forWhom,
    ...
    // Step 2 (Gallery) progress - based on images uploaded (videos are optional)
    const step2Progress = formData.images.length > 0 ? 1 : 0;

    // Calculate total progress based on current step
    if (activeStep === 0) {
      totalProgress = step1Progress * 0.6; // Only count current step progress
    } else if (activeStep === 1) {
      totalProgress = 0.6 + step2Progress * 0.3; // Previous step complete + current step progress
    } else if (activeStep === 2) {
      totalProgress = 0.9 + 0.1; // Both previous steps complete + finish step
    }
  ...
  return (
    <div className=" bg-gradient-to-br from-cyan-300 via-blue-200 to-purple-200 relative ">
      ...
      <div className="absolute inset-0 z-0">
        <img src={GB} alt="Background" className="object-cover w-full h-full" />
      ...
      <div className="relative z-10 px-4 pt-10 pb-4 text-center mt-15">
        <h1 className="font-hugiller text-[52px] sm:text-[64px] md:text-[76px] lg:text-[86px] text-[#263D5D] leading-[1.1] animate-fadeInUp">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 pb-16">
        <div className="grid grid-cols-12 gap-6 lg:gap-10 ">
          {/* Stepper Section - Full width on mobile, left column on larger screens */}
          <div className="col-span-12 md:col-span-4 order-1 md:order-1">
            ...
            {/* Desktop Man Image - hidden on mobile */}
            <div className="hidden md:block relative mt-8 md:mt-10">
              <div className="relative max-w-[520px]">
                <img
                  src={heroMan}
                  alt="Illustration"
                  className="absolute left-[2px] max-w-[500px]  h-auto mb-12 object-contain transform hover:scale-105 transition-transform duration-500 sm:w-auto drop-shadow-2xl"
                />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 items-center gap-4">
                      ...
                      <div className="md:col-span-3 relative flex items-center">
                        ...
                        <FormInput
                          ...
                          title="Enter monthly rent in rupees"
                          type="number"
                        />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 items-center gap-4">
                      ...
                      <div className="md:col-span-3 relative flex items-center">
                        ...
                        <FormInput
                          ...
                          title="Enter your 9-digit Sri Lankan mobile number"
                          maxLength={9}
                          type="tel"
                        />
                      </div>
                ...
                <div className="space-y-8">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <h3 className="font-hugiller text-1xl text-[#263D5D]">
                        Upload Images *
                      </h3>
                    </div>
        ...
        {/* Mobile Man Image - shown only on mobile screens at the bottom */}
